            ...
            <div className="grid grid-cols-1 gap-3 md:gap-4">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-4 relative z-10 pl-2">
                        ...
                        <div className="mt-2 md:mt-0 font-serif italic text-xl text-vogue-black/50 group-hover:text-secret-hot transition-colors">
                            {service.price}
                        </div>
                    </div>
                </button>
        ...
        {step === BookingStep.SELECT_DATE && (
            ...
            <div className="bg-white/80 p-4 md:p-8 rounded-3xl shadow-[0_15px_40px_-5px_rgba(0,0,0,0.05)] border border-gray-100">
                <div className="flex justify-between items-center mb-6 md:mb-8 px-1">
                    <button onClick={handlePrevMonth} className="p-3 md:p-2 hover:bg-gray-50 rounded-full transition-colors"><ChevronLeft size={20} /></button>
                    ...
                    <button onClick={handleNextMonth} className="p-3 md:p-2 hover:bg-gray-50 rounded-full transition-colors"><ChevronRight size={20} /></button>
                </div>
                ...
                {Array.from({ length: totalDays }).map((_, i) => {
                    ...
                    <button
                        ...
                        className={`
                        h-10 w-10 md:h-12 md:w-12 mx-auto flex items-center justify-center font-serif text-base md:text-lg transition-all duration-300 rounded-full relative group
