...
import { ArrowRight, X, Sparkles, Quote, BookOpen, LayoutGrid, StretchHorizontal, ChevronLeft, ChevronRight } from 'lucide-react';
...
const trends = [
    {
        ...
        imageUrl: "/trends/Кибер хром.png",
        color: "text-gray-400"
    },
    {
        id: 2,
        ...
        imageUrl: "/trends/3D био стекло.png",
        color: "text-blue-300"
    },
    {
        id: 3,
        ...
        imageUrl: "/trends/Премиум арт.png",
    ...
    },
    {
        ...
        imageUrl: "/trends/Бархатная Аура1.png",
    ...
    },
    {
        ...
        imageUrl: "/trends/Нео-ТрайблЦикличность моды.png",
        color: "text-white"
    },
    {
        id: 6,
        ...
        imageUrl: "/trends/Невесомость.png",
    ...
    },
    {
        ...
        fullArticle: "Чистое золото в его самом текучем состоянии. Дизайн имитирует капли расплавленного драгоценного металла, стекающие по ногтю. Используются настоящее сусальное золото 24К для создания неповторимой текстуры и блеска. Это манифест богатства и статуса.",
        expertName: "Gigi H.",
        expertRole: "Амбассадор Бренда",
        expertTip: "Идеально на прозрачной или нюдовой базе для эффекта 'золота на коже'.",
        imageUrl: "/trends/Жидкое Золото.png",
    ...
    },
    {
        ...
        fullArticle: "Тренд на экстремальную 'фарфоровую' бледность ногтей. Плотный белый или молочный цвет с глянцевым финишем, напоминающий глазурь. Иногда добавляется эффект 'кракелюра' — тончайшие трещинки, заполненные золотом, как в технике Кинцуги.",
        expertName: "Yoko O.",
        expertRole: "Художник-Керамист",
        expertTip: "Требует идеально увлажненной кутикулы, чтобы не нарушить эффект безупречности.",
        imageUrl: "/trends/Фарфоровая Кожа.png",
        color: "text-white"
    },
    {
        id: 10,
        ...
        imageUrl: "/trends/Цифровая Рептилия.png",
    ...
    },
    {
        ...
        imageUrl: "/trends/Квантовый Индиго.png",
    ...
    },
    {
        ...
        imageUrl: "/trends/Нано-Золото.png",
                        ...
                        {trends.map((trend, idx) => (
                            ...
                            >
                                <Scroll3D delay={viewMode === 'slider' ? 0 : idx * 0.1} className="h-full">
                                    <Tilt3D className="relative aspect-[3/4] overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-700 ease-out border border-white/10 rounded-sm bg-[#0a0a0a] shadow-2xl h-full">
                                        <BlurImage
                                            src={trend.imageUrl} 
                                            alt={trend.title} 
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="bg-white text-black w-full max-w-6xl h-[90vh] md:h-[85vh] rounded-none md:rounded-3xl relative z-10 animate-slide-up shadow-2xl overflow-hidden flex flex-col md:flex-row selection:bg-secret-pink selection:text-white">
                        ...
                        <div className="hidden md:block w-1/2 h-full relative">
                            <img src={selectedTrend.imageUrl} alt={selectedTrend.title} className="absolute inset-0 w-full h-full object-cover" />
