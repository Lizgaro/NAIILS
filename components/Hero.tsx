        ...
        <div className="flex animate-marquee whitespace-nowrap">
            {[...Array(6)].map((_, i) => (
                <div key={i} className="flex items-center gap-12 mx-6 opacity-70">
                    ...
                    <span className="font-sans text-[10px] font-bold uppercase tracking-[0.3em]">МОСКВА 2026</span>
                    <span className="w-1.5 h-1.5 bg-secret-hot rounded-full"></span>
                    <span className="font-serif italic text-2xl text-white font-light">Искусство</span>
                    <span className="w-1.5 h-1.5 bg-secret-hot rounded-full"></span>
                    <span className="font-sans text-[10px] font-bold uppercase tracking-[0.3em]">Идеальный Педикюр</span>
                    <span className="w-1.5 h-1.5 bg-secret-hot rounded-full"></span>
                </div>
            ))}
        </div>
